...
export const STORED_CARDS_EDIT = 'STORED_CARDS_EDIT';
export const STORED_CARDS_EDIT_COMPLETED = 'STORED_CARDS_EDIT_COMPLETED';
export const STORED_CARDS_EDIT_FAILED = 'STORED_CARDS_EDIT_FAILED';
